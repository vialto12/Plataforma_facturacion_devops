...
export class BillingAPIService {
    ...
    public deleteUsingDELETE(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/billing/v1/${encodeURIComponent(String(id))}`,
            {
    ...
    public getUsingGET(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InvoiceResponse>(`${this.basePath}/billing/v1/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public listUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<InvoiceResponse>>(`${this.basePath}/billing/v1`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public postUsingPOST(input: InvoiceRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/billing/v1`,
            input,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public putUsingPUT(id: string, input: InvoiceRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/billing/v1/${encodeURIComponent(String(id))}`,
            input,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
